...
DROP TABLE IF EXISTS tbsebraeshop_municipio;
DROP TABLE IF EXISTS tbsebraeshop_municipio_consumo;
...
DROP TABLE IF EXISTS tbsmicroregiao;
DROP TABLE IF EXISTS tbsmesoregiao;
DROP TABLE IF EXISTS tbsuf;
